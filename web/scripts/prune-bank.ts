...
const ALGO_RULES: Rule[] = [
  ...
  {
    /**
     * Имена методов из листингов учебника: trickleDown, partitionIt,
     * recQuickSort, insertItem. Спецификация спрашивает, что делает алгоритм,
     * а не как автор назвал функцию в своём примере.
     */
    name: "код из учебника (имена методов)",
    re: /\b[a-z]+[A-Z][a-zA-Z]*\s*\(|метод(а|е|ом)?\s+[a-zA-Z]+\s*\(|\b[a-zA-Z]+\(\)/,
    scope: "text",
  },
  {
    name: "привязка к примеру из учебника",
    re: /в програм|в примере|в этом коде|в приведённ|в приложении|данного примера|рассматриваем|исходном примере/i,
    scope: "text",
  },
  {
    /** Сюжетные задачи учебника: города и кабели, агенты, лабиринт с мышью. */
    name: "сюжет из задачи учебника",
    re: /телефонн(ой|ая) книг|город(ах|ов|а)\s|кабел|инспектор|от агента|лабиринт|Эйлер/i,
    scope: "text",
  },
];
...
const DB_RULES: Rule[] = [
  ...
  {
    name: "привязка к примеру из учебника",
    re: /в примере|в этом коде|в приведённ|в приложении|данного примера|рассматриваем|исходном примере/i,
    scope: "text",
  },
];
